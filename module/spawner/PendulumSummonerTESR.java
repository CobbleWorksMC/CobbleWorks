...
public class PendulumSummonerTESR extends TileEntitySpecialRenderer<TileEntityPendulumSummoner> {
	...
	public void renderTileEntityAt(TileEntityPendulumSummoner te, double x, double y, double z, float partialTicks, int destroyStage) {
		...
		//this.bindTexture(new ResourceLocation("cobbleworks", "textures/blocks/newSummoner.png"));
		this.bindTexture(TextureMap.LOCATION_BLOCKS_TEXTURE);
		
		GlStateManager.translate(x, y, z);
		//System.out.println("X: " + x + " Y: " + y + " Z: " + z);
		//System.out.println("X: " + te.getPos().getX() + " Y: " + te.getPos().getY() + " Z: " + te.getPos().getZ());
		...
		//world.spawnParticle(EnumParticleTypes.CRIT, te.getPos().getX()+.5, te.getPos().getY()+.5, te.getPos().getZ()+.5, 0, 0, 0);
