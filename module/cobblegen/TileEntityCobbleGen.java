...
public class TileEntityCobbleGen extends TileEntity implements ITickable, IInventory, IEnergyStorage {
	...
	protected ItemStack[] contents = new ItemStack[this.getSizeInventory()];
	protected String customName;
    protected int ticksSinceEvent = 0; 
    protected int upgradeLevel = 0;
    protected static final int[] tierRequired = new int[] {0, 1, 1, 1, 2, 2, 2, 3, 3};
    ...
    protected int[] produceAmount = new int[] {1, 0, 0, 0, 0, 0, 0, 0, 0};
