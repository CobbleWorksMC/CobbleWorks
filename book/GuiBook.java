...
public class GuiBook extends GuiContainer {
	...
	protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
		...
		if (recipePage) {
			this.fontRendererObj.drawSplitString(display, 33, 70, 118, 0);
			...
			this.fontRendererObj.drawSplitString(CommonProxy.manualRegistry.getPageAt(majorPage).getTooltipText(minorPage), 33, 149, 118, 0);
		} else {
			this.fontRendererObj.drawSplitString(display, 33, 16, 118, 0);
		}
	}
}
