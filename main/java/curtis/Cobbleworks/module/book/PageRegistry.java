...
import curtis.Cobbleworks.module.book.pages.PageHarvester;
import curtis.Cobbleworks.module.book.pages.PageHydroponicSoil;
import curtis.Cobbleworks.module.book.pages.PageLightWand;
import curtis.Cobbleworks.module.book.pages.PageMantaStyle;
import curtis.Cobbleworks.module.book.pages.PageOverview;
import curtis.Cobbleworks.module.book.pages.PagePaydayArmor;
import curtis.Cobbleworks.module.book.pages.PageSpawner;
import curtis.Cobbleworks.module.book.pages.PageSpeedBooster;
import curtis.Cobbleworks.module.book.pages.PageStormshield;
...
public class PageRegistry {
	...
	public void launchPages() {
		...
		if (Config.enableTools) {
			...
			PageSpeedBooster PSB = new PageSpeedBooster();
			PageStormshield PSS = new PageStormshield();
		}
		if (Config.enableMagic) {
			PageAncientStaff PAS = new PageAncientStaff();
		}
		if (Config.enableSpawner) {
			PageSpawner PSP = new PageSpawner();
		}
		
		if (Config.enableArmor) {
			PagePaydayArmor PPA = new PagePaydayArmor();
		}
		
		if (Config.enableFarm) {
			PageHarvester PHV = new PageHarvester();
			PageHydroponicSoil PHS = new PageHydroponicSoil();
		}
	}
